...
namespace TestWcfUtils {
	...
	/// </summary>
	[TestClass]
	public class FaultSafeProxyEmitterTest {

		/// <summary>
		/// The logger.
		/// </summary>
		private readonly static ILog	_log	= LogManager.GetLogger( typeof( FaultSafeProxyEmitterTest ) );
		...
		public void TestCreate() {
			...
			IMockContract channel = FaultSafeProxyEmitter<IMockContract>.Create( "MockEndpoint" );
		...
		public void TestCreate_NotAnInterface() {
			_log.DebugFormat( "TestCreate" );
			FaultSafeProxyEmitter<String>.Create( "MockEndpoint" );
		}

		[TestMethod]
		[DeploymentItem( "log4net.config" )]
		[ExpectedException(typeof( ArgumentOutOfRangeException ))]
		public void TestCreate_NotAServiceContract() {
			_log.DebugFormat( "TestCreate" );
			FaultSafeProxyEmitter<INotAServiceContract>.Create( "MockEndpoint" );
		}
	}
}
