...
namespace Entropa.WcfUtils.Test {
	...
	/// <summary>
	/// This tests the <see cref="FaultSafeServiceReferenceClientEmitter{TInterface,TClient}"/> class.
	/// </summary>
	[TestClass]
	public class FaultSafeServiceReferenceClientEmitterTest {

		/// <summary>
		/// The logger.
		/// </summary>
		private readonly static ILog	_log	= LogManager.GetLogger( typeof( FaultSafeServiceReferenceClientEmitterTest ) );
		...
		public void TestCreate() {
			...
			_log.DebugFormat( " - creating client" );
			IMockContract client = FaultSafeServiceReferenceClientEmitter<IMockContract,MockContractClient>.Create( "NetTcpBinding_IMockContract" );
			Assert.IsNotNull( client, "Channel created" );
			IDisposable disposableChannel = client as IDisposable;
			...
			try {
				...
				_log.DebugFormat( " - disposing client" );
